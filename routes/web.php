...
Route::get('test-vue', function (Request $request) {
...
Route::group(
    [
        ...
        'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath','VisitCounter'],
        'name' => 'front.',
    ],
    function () {
        // new authantication routes
        
        Route::post('login-form', [LoginController::class, 'newLogin'])->name('login-form'); 
        Route::get('login-password', [LoginController::class, 'loginPasswordPage'])->name('login-password-page'); // end new auth routes
        Route::post('login-sumbit', [LoginController::class, 'newLogin'])->name('new-login'); // end new auth routes
        Route::get('otp', [LoginController::class, 'otp'])->name('otp-page'); // end new auth routes
        Route::get('save-otp',[HomeApi::class,'saveOTP']);
        ...
        Route::name('front.')->group(function () {
            ...
            Route::middleware(['auth','VisitCounter'])->group(function () {
