...
return [
    ...
    "phone" => "رقم الهاتف",
    "Language" => "اللغة",
    "register"=>"انشاء حساب الأن",
    "name"=>"الإسم",
    "about"=>"من نحن",
    "customer_number"=>"انت الزائر رقم",
    "Wrong Inputs" => "يوجد شئ خطا في مدخلاتك",
    "Enter Password" => "كلمه المرور ",
    "otp" => "تم ارسال رمز التفعيل الي رقم هاتفك",
    "sendOTP" => "ارسال رمز التفعيل",
    "addPhone" => "رقم التليفون:",
    "sendIt" => "ارسل رمز التفعيل",
    "verfiyCode" => "اضف رمز التفعيل المرسل لك",
    "verfiyIt" => "تاكيد الرمز",
